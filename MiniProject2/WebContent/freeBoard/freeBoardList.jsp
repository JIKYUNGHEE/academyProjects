  ...
  <body>
    ...
    <div class="container">
      ...
      <c:if test="${ count gt 0 }">
         <c:forEach items="${ lists }" var="board" varStatus="loop">
            <tr>   
               <td>${ board.no }</td>
               <td>
      ...
      <c:if test="${startPage gt pageBlock}">
         <li><a href="/MiniProject2/freeBoardList.do?pageNum=${startPage-pageBlock}">이전</a></li>
      </c:if>
      ...
      <c:if test="${ endPage lt pageCount }">
      	<li><a href="/MiniProject2/freeBoardList.do?pageNum=${startPage+pageBlock}">다음</a></li>
      </c:if>
      </ul>
      </div>
