...
carousel({id:'blueb',
          ...
          speed:5, 
          direction:'left', 
          images:['/Project-Web/Resources/img/1.jpg',
                  '/Project-Web/Resources/img/2.jpg',
                  '/Project-Web/Resources/img/7.jpg',
                  '/Project-Web/Resources/img/8.jpg',
                  '/Project-Web/Resources/img/4.jpg',
                  '/Project-Web/Resources/img/8.jpg',
                  '/Project-Web/Resources/img/8.jpg',
                  '/Project-Web/Resources/img/6.jpg'],
